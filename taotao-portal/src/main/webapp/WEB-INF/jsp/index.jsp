...
<div class="w">
    ...
    <div id="jdnews" class="m m1">
        <div class="mt">
            <h2>淘淘快报</h2>
            <div class="extra" clstag="homepage|keycount|home2013|11a"><a
                    href="http://www.jd.com/moreSubject.aspx" target="_blank">更多快报&nbsp;&gt;</a>
            </div>
        </div>
        <div class="mc">
            <ul>
            ...
            <ul class="fore1 lh">
                <li class="fore1 abtest_huafei"
                    ...
                    clstag="homepage|keycount|home2013|12a"><a target="_blank"
                                                               href="http://chongzhi.jd.com/"><s></s>话费<i></i></a>
                </li>
                <li class="fore2 abtest_lvxing" data-iframe="http://trip.jd.com/html/newTravel.html"
                    clstag="homepage|keycount|home2013|12b"><a target="_blank"
                                                               href="http://trip.jd.com/"><s></s>旅行<i></i></a>
                </li>
                <li class="fore3 abtest_caipiao" data-iframe="http://caipiao.jd.com/caipiao-jd.htm"
                    clstag="homepage|keycount|home2013|12c"><a target="_blank"
                                                               href="http://caipiao.jd.com/"><s></s>彩票<i></i></a>
                </li>
                <li class="fore4 abtest_youxi"
                    ...
                    clstag="homepage|keycount|home2013|12d"><a target="_blank"
                                                               href="http://game.jd.com/"><s></s>游戏<i></i></a>
                </li>
            </ul>
            <ul class="fore2 lh">
                <li class="fore5 abtest_jipiao" clstag="homepage|keycount|home2013|12e"><a
                        target="_blank" href="http://jipiao.jd.com/"><s></s>机票</a></li>
                <li class="fore6 abtest_dianyingpiao" clstag="homepage|keycount|home2013|12f"><a
                        target="_blank" href="http://movie.jd.com/"><s></s>电影票</a></li>
                <li class="fore7 abtest_yanchupiao" clstag="homepage|keycount|home2013|12g"><a
                        target="_blank" href="http://licai.jd.com/"><s></s>理财</a></li>
                <li class="fore8 abtest_shuidianmei" clstag="homepage|keycount|home2013|12h"><a
                        target="_blank" href="http://jiaofei.jd.com/"><s></s>水电煤</a></li>
            </ul>
        </div>
        <div class="mc">
...
<div id="floors-list">
    <div class="w w1" data-fid="0" id="electronics">
        <div class="m m1 catalogue" data-lazyload="1">
            <div class="mt ld">
                <div class="floor"><b class="fixpng b b1"></b><b class="fixpng b b2"></b><b
                        class="b b3">1F</b><b class="fixpng b4"></b></div>
                <h2>家电通讯</h2>
            </div>
            <div class="mc">
                <div class="style1">
...
<!-- 广告信息 -->
	<a target="_blank" title=""
       href="http://c.fa.jd.com/adclick?sid=2&cid=601&aid=3624&bid=0&unit=35989&advid=105087&guv=&url=http://sale.jd.com/act/PzKvRu4Ld5YnG1Ej.html">
		<img data-img="2" data-lazyload="/images/543b4d75N686689d7.jpg" width="209" height="155"
             alt=""/>
	</a>
</span>
                </div>
