    ...
    a.fn.dropdown = function (b, c) {
        ...
        a.each(this, function () {
            function d() {
                ...
                var b = g.offset(), c = {x: b.left, y: b.top}, d = {
                    x: b.left + g.outerWidth(),
                    y: c.y
                }, e = {x: b.left, y: b.top + g.outerHeight()}, f = {
                    x: b.left + g.outerWidth(),
                    y: e.y
                };
        ...
        var k = function () {
            ...
            switch (f.css({
                ...
                case "down":
                    ...
                    break;
                case "left":
                    f.css({marginTop: 0, marginLeft: 0}), d.css({
                        marginTop: 0,
                        marginLeft: j + "px"
                    }), e.pos.clone = j;
                    break;
...
var category = {
    ...
    FN_BindEvents: function () {
        ...
        $("#settleup-content .delete").bind("click", function () {
            var b = $(this).attr("data-id").split("|"), c = $(this).attr("data-type"), d = {
                method: c,
                cartId: b[0]
            };
